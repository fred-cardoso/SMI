                            ...
                            <div class="box">
                                ...
                                <div class="box box-footer">
                                    ...
                                    <div id="prepareDownload" class="col-sm-2" style="display:none">
                                        ...
                                        <input type="checkbox" name="request_category">@lang('conteudos.request_cat')
                                        <br>
                                        <input type="checkbox"
                                               name="request_description">@lang('conteudos.request_desc')
                                    </div>
                                    <div class="col-sm-2" id="prepareDownloadbut" style="display:none">
                                        <button type="button" onclick="submitform()"
                                                class="btn btn-success">@lang('conteudos.download')
                                        </button>
                                    </div>
